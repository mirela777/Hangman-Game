var words = ['cat', 'dog', 'orange',' apple','power', 'internet', 'software','country','decision','education','error'];
var answerArray = []; 
var totalGuesses;
var counter = 0;
...
function checkLetter(letter){
     ...
     for (var i = 0; i < answerArray.length; i++){
         if(letter == answerArray[i]){
            contains = 1;
            counter ++;
            document.getElementById( "guessedLetters").children[i].innerText = letter;
         }
      }
         if(contains == 0){
